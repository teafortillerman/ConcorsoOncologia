...
> !!Verifica in letteratura — aggiornamento:!! I dati di OS matura di EMERALD-1 e LEAP-012 sono ora disponibili e sono **negativi**, a differenza di quanto indicato in versioni precedenti di questa scheda (che li descrivevano come "OS non ancora matura"). EMERALD-1: OS 29,9 (durva+bev+TACE) vs 33,6 (durva+TACE) vs 33,3 mesi (TACE) — nessun beneficio. LEAP-012: OS HR 0,80, p=0,087 (non significativo), chiuso precocemente per futilità. È stato inoltre pubblicato un secondo trial adiuvante negativo, **KEYNOTE-937** (pembrolizumab, RFS HR 1,06, p=0,719), che si aggiunge a IMbrave050 nel confermare che l'immunoterapia adiuvante non ha, ad oggi, un ruolo dimostrato nell'HCC dopo trattamento locale radicale.

#### Punti chiave — novità 2025-2026
- Triplette IO (IMbrave152/SKYSCRAPER-14, TRIPLET-HCC): entrambe negative, il doppietto resta standard.
- EMERALD-1 (TACE+durva±bev) e LEAP-012 (TACE+pembro+lenva) in BCLC-B: OS ora MATURA e NEGATIVA in entrambi (EMERALD-1: 29,9 vs 33,6 vs 33,3 mesi; LEAP-012: HR 0,80, p=0,087, chiuso per futilità) — aggiornamento critico rispetto a dati preliminari precedenti.
...
- **HIMALAYA/STRIDE**: OS 5a 19,6% vs 9,4% — non richiede endoscopia, unico regime che include Vp4.
