...
Il carcinoma a cellule di Merkel (MCC) è una neoplasia neuroendocrina cutanea rara ma aggressiva, considerata il paradigma di risposta all'immunoterapia in oncologia cutanea. Viene gestito in ambito oncologico medico/dermato-oncologico e, per l'origine neuroendocrina delle cellule di Merkel, è trattato nella stessa linea guida AIOM dedicata alle neoplasie neuroendocrine. Riferimenti principali: AIOM Neuroendocrini 2024 (capitolo dedicato) ed ESMO Clinical Practice Guideline sul Carcinoma di Merkel 2024.


## Epidemiologia
L'incidenza del MCC è in costante crescita: i dati SEER mostrano un aumento da 0,22 casi/100.000 nel 1986 a 0,79/100.000 nel 2011, con la mortalità salita parallelamente da 0,03 a 0,43/100.000. In Europa si stimano circa 2.500 nuovi casi/anno. La malattia colpisce tipicamente pazienti anziani (età mediana alla diagnosi 76 anni), con lieve prevalenza maschile (M:F ~2:1) e una netta predilezione per la popolazione caucasica, colpita circa 8 volte più frequentemente rispetto ad altre etnie.
...
## Diagnosi
Il MCC si presenta tipicamente come un nodulo cutaneo indolore a crescita rapida, localizzato in aree fotoesposte. Il sospetto clinico è aiutato dall'**acronimo AEIOU** proposto da Heath et al.: **A**sintomatico (presente nell'88% dei casi), **E**spansione rapida in meno di 3 mesi (63%), **I**mmunosoppressione (18%), **O**lder age, cioè età >50 anni (90%), **U**V-exposed/fototipo chiaro (81%). Le sedi più colpite sono la regione testa-collo (45-48%), gli arti superiori (24%) e inferiori (10-15%), mentre il tronco è interessato in meno dell'11% dei casi; nell'**11%** dei pazienti il primitivo cutaneo non è identificabile.

La diagnosi istologica si avvale di un pannello immunoistochimico caratteristico: la **CK20** mostra un pattern paranucleare puntiforme "a dot" (o cap-like), la **sinaptofisina** è positiva nel 100% dei casi, la cromogranina è positiva con pattern dot-like. Il dato più cruciale per la diagnosi differenziale è che il **TTF-1 è sempre negativo** nel MCC — un elemento chiave per distinguerlo dalle metastasi cutanee di carcinoma polmonare a piccole cellule (SCLC), che sono invece TTF-1 positive.
...
## Biomarcatori
Lo stato di MCPyV (presente/assente) correla con la biologia molecolare del tumore (vedi sopra) ma **non guida attualmente la scelta terapeutica**: i pazienti MCPyV+ e MCPyV- rispondono in modo sovrapponibile all'immunoterapia. Il **PD-L1** è iperespresso in entrambi i sottogruppi biologici e costituisce il razionale dell'immunoterapia, ma non è un biomarcatore selettivo per la scelta del farmaco (nessuna soglia di espressione guida oggi la pratica clinica). L'infiltrazione linfocitaria intratumorale, in particolare i linfociti CD8+, correla con una prognosi più favorevole.

Un biomarcatore emergente, già disponibile clinicamente negli Stati Uniti ma non ancora diffuso in Italia, è il test sierologico anti-oncoproteina del poliomavirus di Merkel (pannello **AMERK**), utile nei pazienti MCPyV+: la sieropositività basale (titolo ≥75) si associa a sopravvivenza libera da recidiva, evento-libera, globale e malattia-specifica migliori nella malattia localizzata, e un titolo in ascesa durante il follow-up può precedere la comparsa di metastasi radiologicamente evidenti, risultando un utile complemento (non un sostituto) dell'imaging nella sorveglianza post-trattamento.
...
La **radioterapia adiuvante sul letto tumorale** (50-60 Gy) è raccomandata nella quasi totalità dei casi: la metanalisi di Petrelli del 2019, su 17.179 pazienti, ha dimostrato un beneficio significativo in OS (**HR 0,81**), con una riduzione dell'80% delle recidive locali e del 70% di quelle locoregionali. Anche la **RT sui linfonodi dopo linfonodo sentinella positivo** riduce il rischio di recidiva locoregionale (0% vs 16,7%), sebbene senza un impatto dimostrato su OS o PFS.
...
Nella malattia avanzata/metastatica, l'**immunoterapia anti-PD-1/PD-L1 rappresenta lo standard sia di prima sia di seconda linea**, avendo sostituito la chemioterapia come approccio iniziale.

L'**avelumab** (anti-PD-L1) è stato il primo farmaco approvato in questa indicazione, sulla base dello studio **JAVELIN Merkel 200**: nella coorte pretrattata (parte A) l'ORR è del 33%, con un follow-up ormai maturo di oltre 5 anni che conferma un'OS mediana di 12,6 mesi e un tasso di OS a 5 anni del **26%**; nella coorte naïve trattata in prima linea (parte B), l'ORR sale al 62%, con OS mediana di 20,3 mesi e OS a 4 anni del **38%**. Avelumab è approvato sia da EMA sia da FDA dal 2017, indipendentemente dalla linea di trattamento, ed è ==rimborsato in classe H (con registro di monitoraggio AIFA dedicato) anche in Italia==.

> ++Verifica in letteratura:++ il follow-up a lungo termine di JAVELIN Merkel 200 è ora pubblicato per entrambe le coorti: OS a 5 anni 26% nei pretrattati (D'Angelo et al., *ESMO Open* 2021) e OS a 4 anni 38% nei naïve di prima linea (D'Angelo et al., *ESMO Open* 2024) — dati che confermano, con follow-up ormai maturo, il beneficio a lungo termine già suggerito dai dati preliminari citati nella versione precedente della scheda.
>
> ++Verifica in letteratura (stato AIFA):++ confermato lo stato di rimborsabilità italiano di avelumab (Bavencio) per il MCC metastatico, indipendente dalla linea di trattamento. Iter regolatorio: EMA ha approvato l'indicazione il 18 settembre 2017; AIFA ha inizialmente classificato il farmaco in **classe C(nn)** con determina del 19 gennaio 2018 (in attesa della domanda di rimborsabilità); la classificazione definitiva in **classe H** (uso ospedaliero, con registro di monitoraggio AIFA dedicato attivo dal 25 settembre 2018) è stata pubblicata con determina del 3 settembre 2018 (G.U. 24/09/2018, n. 18A06050). Non risultano eventi regolatori EMA/AIFA successivi al 2020 che modifichino questa indicazione (la determina AIFA del 5/11/2020 e quella dell'11/3/2022 su Bavencio riguardano rispettivamente il carcinoma renale e quello uroteliale, non il MCC). Fonti: [AIFA — scheda indicazione Bavencio](https://www.aifa.gov.it/sites/default/files/BAVENCIO_12776_v1.0.pdf), [AIFA — pubblicazione registro di monitoraggio Bavencio](https://www.aifa.gov.it/en/-/pubblicazione-schede-di-monitoraggio-registro-bavencio), [Determina AIFA 19.01.18](https://www.medicoeleggi.com/argomenti000/italia2018/410064-a.htm), [Notiziario Chimico Farmaceutico, ago. 2019](https://www.notiziariochimicofarmaceutico.it/2019/08/22/rimborsabile-avelumab-per-il-mcc-metastatico/).

Il **pembrolizumab** ha una solida base di evidenza dagli studi KEYNOTE-017 (fase II, 50 pazienti naïve, ORR 56%, OS a 24 mesi 68,7%) e KEYNOTE-913 (disegnato come studio registrativo di fase III a braccio singolo, con analisi definitiva pubblicata nel 2024): con un follow-up mediano di oltre 4 anni (50,3 mesi) su 55 pazienti, l'ORR è del 49%, la durata di risposta mediana è di 39,8 mesi (tasso di DOR a 24 mesi del 69%), l'OS mediana è di 24,3 mesi con un tasso di OS a 24 mesi del 51%. Pembrolizumab ha approvazione FDA (accelerata, dicembre 2018) ma non EMA per questa indicazione.

> ++Verifica in letteratura (stato regolatorio):++ confermato, ad agosto 2026, che pembrolizumab **non ha un'indicazione EMA per il MCC** (nessuna EPAR europea per questa neoplasia risulta pubblicata su [ema.europa.eu](https://www.ema.europa.eu/en/medicines/human/EPAR/keytruda)), nonostante l'approvazione FDA risalga al 2018 e i dati KEYNOTE-913 siano ormai maturi (2024). Di conseguenza pembrolizumab **non è rimborsabile in Italia per il MCC** (l'AIFA non ha alcuna determina di classificazione per questa indicazione); resta invece ampiamente rimborsato in Italia per le sue numerose altre indicazioni oncologiche.

Il **nivolumab**, studiato nel programma CheckMate 358, ha dati aggiornati e maturi pubblicati nel 2025: in monoterapia (pazienti naïve da checkpoint inibitori) l'ORR è del 60%, con un'OS mediana particolarmente favorevole di **80,7 mesi**; l'aggiunta di ipilimumab non ha migliorato l'efficacia (ORR 58%, OS mediana 29,8 mesi, inferiore alla sola monoterapia) pur aumentando la tossicità di grado 3-4 (47% vs 28%) — un risultato che smentisce i segnali preliminari di beneficio dalla combinazione riportati in analisi precedenti e meno mature. Nel setting neoadiuvante, sempre nell'ambito di CheckMate 358, nivolumab somministrato circa 4 settimane prima della chirurgia ha indotto una risposta patologica completa (pCR) nel **47,2%** dei pazienti operati, con RFS e OS non ancora raggiunte al follow-up mediano di 20,3 mesi e nessuna recidiva osservata tra i pazienti con pCR. Nivolumab non ha, a oggi, un'approvazione regolatoria specifica EMA o FDA per il MCC.

> ++Verifica in letteratura (stato regolatorio):++ confermato ad agosto 2026 — nivolumab resta privo di un'indicazione EMA o FDA specifica per il MCC (il suo utilizzo nel CheckMate 358 è di natura sperimentale/off-label) e non risulta pertanto alcuna determina AIFA di classificazione/rimborsabilità per questa indicazione. L'uso nel MCC in Italia è quindi possibile solo entro un contesto di sperimentazione clinica o, eventualmente, di uso compassionevole/off-label motivato, non come terapia standard rimborsata.

> ++Verifica in letteratura:++ l'ORR di CheckMate 358 riportato nella versione precedente della scheda (64-68%) corrispondeva a un'analisi interim; la pubblicazione con follow-up maturo (Bhatia et al., *J Clin Oncol* 2025) riporta ORR 60% in monoterapia e conferma l'assenza di vantaggio dalla combinazione con ipilimumab, con un'OS mediana di 80,7 mesi in monoterapia — tra i dati di sopravvivenza più favorevoli mai riportati nel MCC avanzato.
...
- Immunoterapia: ==avelumab (EMA/FDA 2017, I-II linea, AIFA classe H con registro di monitoraggio, rimborsato in Italia)==, ++pembrolizumab (solo FDA, non EMA — non rimborsabile in Italia per il MCC)++, !!nivolumab (non approvato EMA/FDA, uso solo sperimentale/off-label — nessuna rimborsabilità AIFA)!!, !!retifanlimab (solo FDA — l'EMA lo ha approvato, marzo 2026, solo per il carcinoma squamocellulare anale, non per il MCC — non disponibile né rimborsabile in Italia per il MCC)!!.
- Chirurgia/RT: WLE + SLNB + RT adiuvante.
- Immunoterapia adiuvante (in studio, non ancora standard): pembrolizumab (STAMP), avelumab (ADAM).
- Chemioterapia: platino/etoposide, taxani, topotecan (ruolo residuale/controindicato in adiuvante).


## Tossicità e criticità
L'immunoterapia in questa indicazione presenta il profilo di tossicità immuno-relata tipico di classe: nello studio registrativo di avelumab si sono osservati eventi di grado 3 nel 5-11% dei pazienti, senza decessi farmaco-correlati né eventi di grado 4. Anche i dati più recenti sull'immunoterapia in setting adiuvante confermano un profilo di tossicità non trascurabile in pazienti operati e potenzialmente guariti: nello studio STAMP gli eventi di grado ≥3 sono stati del 31% con pembrolizumab (vs 4% con la sola osservazione), inclusa una polmonite immuno-relata fatale; nello studio ADAM gli eventi di grado 3-4 con avelumab sono stati del 15% (vs 0% con placebo) — un dato da considerare sempre nel bilanciare rischi e benefici di un trattamento adiuvante il cui beneficio in RFS/OS non è (ancora) dimostrato in modo definitivo.

La chemioterapia, dal canto suo, ha una mortalità tossica elevata (3-10%) in questa popolazione tipicamente anziana e fragile, un ulteriore argomento a favore della preferenza per l'immunoterapia quando applicabile.
...
- **SLNB raccomandata**; chirurgia margini 1-2cm + **RT adiuvante quasi sempre** (HR OS 0,81).
- **Chemioterapia adiuvante controindicata** — possibile danno per immunosoppressione; l'immunoterapia adiuvante (STAMP/ADAM) resta invece un dato emergente, non ancora standard.
- **Avelumab (JAVELIN Merkel 200)** = primo IO approvato (EMA/FDA 2017); ORR 33-62% a seconda della linea, OS a lungo termine 26-38%; ==in Italia rimborsato in classe H con registro AIFA dal 2018==.
- **Retifanlimab**: solo FDA (2023) per il MCC — l'approvazione EMA (marzo 2026) riguarda solo il carcinoma anale, non il Merkel; !!non disponibile/rimborsabile in Italia per il MCC!!.
- **Nivolumab (CheckMate 358)**: OS mediana 80,7 mesi in monoterapia nei dati maturi; la combinazione con ipilimumab non è superiore.
- Follow-up intensivo per l'altissimo rischio di recidiva (fino 91% linfonodale).


## Errori da evitare
- Non offrire chemioterapia adiuvante dopo chirurgia radicale (nessun beneficio, possibile danno).
- Non confondere MCC con metastasi cutanea da SCLC — verificare sempre TTF-1 (negativo nel MCC).
- Non trascurare la RT adiuvante anche dopo escissione con margini adeguati (beneficio dimostrato su OS).
- Non sottovalutare il rischio di recidiva a lungo termine — follow-up intensivo necessario oltre i 3 anni.
- Non affermare che retifanlimab è approvato EMA per il carcinoma di Merkel: l'approvazione europea di Zynyz copre solo il carcinoma squamocellulare del canale anale.
- Non presentare l'immunoterapia adiuvante (pembrolizumab/STAMP, avelumab/ADAM) come standard di cura consolidato: entrambi gli studi hanno mancato l'endpoint primario di RFS e restano dati emergenti.


## Fonti
- AIOM: Neoplasie Neuroendocrine 2024 (capitolo Carcinoma a cellule di Merkel).
- ESMO: CPG Carcinoma Merkel 2024.
- D'Angelo SP et al. First-line avelumab treatment: 4-year follow-up JAVELIN Merkel 200 part B. ESMO Open 2024. [DOI](https://doi.org/10.1016/j.esmoop.2024.103461)
- D'Angelo SP et al. Avelumab in previously treated mMCC: updated OS after >5 years of follow-up (JAVELIN Merkel 200 part A). ESMO Open 2021. [DOI](https://doi.org/10.1016/j.esmoop.2021.100290)
- Nghiem P et al. Pembrolizumab first-line in advanced MCC: KEYNOTE-017. J Clin Oncol 2019. [DOI](https://doi.org/10.1200/JCO.18.01896)
- Mortier L et al. Pembrolizumab first-line treatment of MCC: KEYNOTE-913. Am J Clin Dermatol 2024. [DOI](https://doi.org/10.1007/s40257-024-00885-w)
- Bhatia S et al. Nivolumab with or without ipilimumab in recurrent/metastatic MCC: CheckMate 358. J Clin Oncol 2025. [DOI](https://doi.org/10.1200/JCO-24-02138)
- Topalian SL et al. Neoadjuvant nivolumab for resectable MCC: CheckMate 358. J Clin Oncol 2020. [DOI](https://doi.org/10.1200/JCO.20.00201)
- Grignani G et al. Phase II study of retifanlimab in recurrent/metastatic MCC: POD1UM-201. J Immunother Cancer 2025. [DOI](https://doi.org/10.1136/jitc-2025-012478)
- STAMP (ECOG-ACRIN EA6174): adjuvant pembrolizumab in resected MCC, fase III — dati presentati ASCO/ESMO 2025-2026, non ancora pubblicazione per esteso.
