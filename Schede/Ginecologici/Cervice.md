...
> ++Verifica in letteratura:++ questa indicazione (KEYNOTE-826, PD-L1 CPS ≥1) è **rimborsata da AIFA in classe H** già dalla Determina del 10.07.2023, con riconoscimento di innovatività terapeutica piena — non è quindi un'indicazione recente in Italia, ma consolidata da oltre tre anni. [Determina AIFA 10.07.23 – Keytruda](https://www.medicoeleggi.com/argomenti000/italia2023/415503-1.htm).
...
Il **cemiplimab** (EMPOWER-Cervical 1/GOG-3016/ENGOT-cx9, Tewari NEJM 2022) è stato il primo anti-PD-1 approvato in monoterapia in seconda linea dalla Commissione Europea (22 novembre 2022), indipendentemente dallo stato PD-L1 o dall'istotipo. L'analisi finale di OS, con un follow-up mediano di 30,2 mesi, conferma il beneficio già osservato nell'analisi a interim: OS di 11,7 contro 8,5 mesi nella popolazione totale (HR 0,656), con un beneficio presente sia nell'istotipo squamoso sia nell'adenosquamoso.

> !!Verifica in letteratura — attenzione:!! il **label EMA di cemiplimab è PD-L1-indipendente**, ma **AIFA ne ha ristretto la rimborsabilità ai soli tumori con PD-L1 ≥1%** (Determina 309/2024 del 16.07.2024, classe H, registro di monitoraggio dedicato). Una paziente PD-L1 <1%, pur rientrando nel label EMA, non ha quindi accesso al farmaco a carico SSN in Italia: un trabocchetto tipico da tenere a mente, perché la scheda precedente non segnalava alcuna limitazione biomarcatore-based per questo farmaco. [Determina AIFA 309/2024 – Libtayo](https://www.aifa.gov.it/documents/20142/961234/Determina_309-2024_Libtayo.pdf). Il **tisotumab vedotin**, ADC diretto contro il tissue factor, ha mostrato nello studio innovaTV 301 un ORR del 25% ed è oggi approvato non solo dalla FDA (2024) ma anche dalla **Commissione Europea (marzo 2025)** per il carcinoma cervicale recidivante/metastatico pretrattato.
...
> ++Verifica in letteratura:++ nonostante l'approvazione EMA/CE del marzo 2025, alla data di questa verifica **non risulta ancora pubblicata una determina AIFA di rimborsabilità** per tisotumab vedotin (nessun registro di monitoraggio dedicato attivo su registri.aifa.gov.it, nessuna determina in Gazzetta Ufficiale reperibile): il farmaco è quindi verosimilmente **autorizzato ma non ancora rimborsato dal SSN** (presumibile classe C-nn in attesa di negoziazione), non ancora un'opzione concretamente prescrivibile a carico del servizio sanitario in Italia. [Elenco registri AIFA](https://www.aifa.gov.it/en/registri-e-piani-terapeutici1).
...
Per lo stato di rimborsabilità AIFA aggiornato di ciascun farmaco (classe, data determina, limitazioni) vedi la scheda trasversale `Schede/Trasversali/Rimborsabilita.md`, sezione `## Cervice`.
...
- Non assumere che cemiplimab in 2L sia prescrivibile a carico SSN indipendentemente da PD-L1 solo perché lo è il label EMA: **AIFA rimborsa solo i CPS ≥1%**.
- Non presentare tisotumab vedotin come già rimborsato in Italia solo perché approvato da EMA/CE: alla data di questa verifica non risulta ancora una determina AIFA.
