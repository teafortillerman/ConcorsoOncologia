...
Nel CheckMate 025, nivolumab contro everolimus ha mostrato un HR per OS di 0,73 (25,8 contro 19,7 mesi), con un beneficio indipendente dallo stato di PD-L1. Nel METEOR, cabozantinib contro everolimus ha mostrato un HR per OS di 0,70 e per PFS di 0,51 — il miglior farmaco disponibile dopo un TKI. Il RECORD-1 (everolimus) ha mostrato un HR per PFS di 0,33, ma l'OS non è risultata significativa per un crossover dell'80%.
