...
from algoritmi import load_algorithms
...
algorithms, algo_errors = load_algorithms(ROOT)
if algo_errors:
    print("Errori negli algoritmi — indice NON aggiornato:", file=sys.stderr)
    for err in algo_errors:
...
print(f"Creato indice con {len(all_items)} risorse e {len(algorithms)} algoritmi in {OUT}")